...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string baseSvg2 = ")'><stop offset='0%' style='stop-color:rgb(102,153,255);stop-opacity:1' /><stop offset='100%' style='stop-color:rgb(255,51,102);stop-opacity:1' /></linearGradient></defs><rect width='100%' height='100%' fill='url(#grad)' /><text x='50%' y='50%' fill='#ffffff' font-size='24' font-family='Arial' font-weight='600' dominant-baseline='middle' text-anchor='middle'>";
